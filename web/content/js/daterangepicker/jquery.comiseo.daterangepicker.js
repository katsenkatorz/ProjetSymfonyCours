...
//				showCurrentAtPos: 1 // bug; use maxDate instead
        ...
        getHightlightedElements: function () {
            return this._dateRangePicker.getHightlightedElements();
        },
     ...
     */
    function buildCalendar(classnameContext, options, handlers) {
        var $self,
            applyButton,
    ...
    function buildDateRangePicker($originalElement, options) {
        ...
        function getHightlightedElements() {
            var elems = $('.ui-state-highlight');
            return elems.html();
        }
        ...
        return {
            ...
            setRange: setRange,
            getRange: getRange,
            getHightlightedElements: getHightlightedElements,
